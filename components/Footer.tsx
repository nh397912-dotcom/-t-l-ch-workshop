        ...
        <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm opacity-70 font-sans">
              <li><a href="https://gom-my-thien.vercel.app/" target="_blank" rel="noopener noreferrer" className="hover:text-brand-clay transition-colors">Khám phá Di sản Mỹ Thiện</a></li>
